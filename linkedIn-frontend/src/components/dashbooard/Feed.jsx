        ...
        <>
          ...
          <div key={post._id} className="flex flex-col gap-3">
            <p className="text-sm m-2">
              {post.description ||
                " Lorem ipsum, dolor sit amet consectetur adipisicing elit. Animi delectus distinctio quod eius error culpa deleniti pariaturinventore, ullam natus, atque cumque obcaecati nisi quam enim incidunt vitae. Magni et labore corrupti optio odio vero aliquam"}
            </p>
            <img src={post.image || navbarLogo} alt="" className="h-80 w-80" />
            <hr />
